...
def merge_kernel_cmdline(cmdline1, cmdline2):
    """Merge two kernel command lines.

    Merge two kernel command lines, if there are duplicated options the
    ...
    :returns: A kernel command line string containing the options from
        cmdline1 and cmdline2.

    """
    cmdline = _parse_kernel_cmdline(cmdline2)
